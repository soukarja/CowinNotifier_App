...
//        testMode = true; // debug
        ...
        if (testMode) {
            ...
            this.FacebookBanner1 = "829049141062090_829050204395317";
            this.FacebookBanner2 = "829049141062090_829050397728631";
            this.FacebookBanner3 = "829049141062090_829050627728608";
            this.FacebookInterstitialAdCode = "829049141062090_829049697728701";
            this.FacebookRewardedAdCode = "";


            this.GoogleBanner1 = "ca-app-pub-8318706732545213/9313616493";
            this.GoogleBanner2 = "ca-app-pub-8318706732545213/5182799795";
            this.GoogleBanner3 = "ca-app-pub-8318706732545213/9901893563";
            this.GoogleInterstitialAdCode = "ca-app-pub-8318706732545213/4991228102";
    ...
    public void showBannerAds(com.facebook.ads.AdView fBBanner, com.google.android.gms.ads.AdView googleBanner) {
        Log.d("adsMsg", "FB: "+String.valueOf(canShowFacebookAds()));
        Log.d("adsMsg", "google: "+String.valueOf(canShowGoogleAds()));
...
//            return false;
    ...
    private void updateFacebookClicks() {
        ...
        ed.commit();
        Log.d("adsTest", "FB Clicked"+String.valueOf(clicks+1));
    }
    ...
    private void updateGoogleClicks() {
        ...
        ed.commit();
        Log.d("adsTest", "Google Clicked"+String.valueOf(clicks+1));
    }
    ...
    private void updateGoogleImpressions() {
        ...
        ed.commit();
        Log.d("adsTest", "Google Imp"+String.valueOf(clicks+1));
    }
